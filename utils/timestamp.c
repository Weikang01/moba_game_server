...
%C Century (year divided by 100 and truncated to integer)
%d Day of the month as a zero-padded decimal number (01-31)
%D Short date format: MM/DD/YY
%e Day of the month as a space-padded decimal number (1-31)
%F Full date format: YYYY-MM-DD
%g Year without century as a zero-padded decimal number (00-99)
%G Year with century as a decimal number
...
%r 12-hour time in the format: hh:mm:ss AM/PM
...
%V ISO 8601 week number of the year (week 01-53, with Monday as the first day of the week)
...
%z, %Z Time zone name or abbreviation, or empty string if not available
*/
