...
CharacterInfo::CharacterInfo(const CharacterInfo& from)
  ...
  ::memcpy(&_impl_.seatid_, &from._impl_.seatid_,
    ...
    reinterpret_cast<char*>(&_impl_.seatid_)) + sizeof(_impl_.characterid_));
